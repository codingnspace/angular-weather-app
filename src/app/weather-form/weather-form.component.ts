...
export class WeatherFormComponent implements OnInit {
 ...
 weekDays: any = this.nextSevenDays
  ...
  onSubmit() {
    this.results = this.weekDays.map(dayWithOffset => {
      const morningCommute = this.weather.hourly && this.weather.hourly.data[8];
      const eveningCommute = this.weather.hourly && this.weather.hourly.data[17];
